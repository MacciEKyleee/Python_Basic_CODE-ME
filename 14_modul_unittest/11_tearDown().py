"""
Zadanie 11
Utwórz pustą metodą tearDown().
Do wszystkich metod w pliku testowym dodaj proste wyświetlanie, która metoda właśnie się wykonuje.
Uruchom test i przeanalizuj kolejność wykonywania. [rozwiązanie: test_student.py]
"""
import unittest
