...
def print_day(day):
    ...
    pdf.output(f'Weather_data_{day}.pdf', 'F')

# def print_day(day):
#     print(f"Date: {day['date']}")
#     print(f"\tsunrise: {day['sunrise']}")
#     print(f"\tsunset: {day['sunset']}")
#     print(f"\tminimal temperature: {day['tmin']}")
#     print(f"\tmaximal temperature: {day['tmax']}")
#     print(f"\ttemperature during the day: {day['tday']}")
#     print(f"\ttemperature at night: {day['tnight']}")
#     print(f"\tweather: {day['weather']}")
#     print(f"\tpressure: {day['pressure']}")
